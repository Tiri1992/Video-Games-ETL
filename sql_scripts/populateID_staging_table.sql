...
set
	source_data_staging.GenreID = d_genre.GenreID
...
set
	source_data_staging.NameID = d_name.NameID
...
set
	source_data_staging.PlatformID = d_platform.PlatformID
where source_data_staging.Platform = d_platform.Platform
and source_data_staging.Publisher = d_platform.Publisher
